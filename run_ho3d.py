...
def run_all():
    video_dirs = sorted(glob.glob("/home/justin/data/HO3D_V3/evaluation/*"))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_dirs",
        type=str,
        default="/home/justin/data/HO3D_V3/evaluation/MPM10",
    )
    parser.add_argument(
        "--out_dir",
        type=str,
        default="/home/justin/code/point-to-pose/results/bundlesdf/ho3d",
    )
