...
def benchmark_one_video(method, video_dir):
    ...
    if benchmark_mesh:
        ...
        if len(tmp) > 0:
            ...
            pred_mesh_file = sorted(
                glob.glob(f"{dir}/**/*mesh_normalized_space.obj", recursive=True)
            )[-1]
            ...
            pred_mesh.vertices = pred_mesh.vertices / cfg[
                "sc_factor"
    ...
    return {
        ...
        f"{method}/{video_name}/chamfer_dist(cm)": cd,
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_dirs",
        type=str,
        default="/home/justin/data/HO3D_V3/evaluation/SM1",
    )
    parser.add_argument(
        "--out_dir",
        type=str,
        default=f"/home/justin/code/point-to-pose/results/bundlesdf/ho3d",
    )
    parser.add_argument(
        "--log_dir",
        type=str,
        default=f"/home/justin/code/point-to-pose/results/bundlesdf/ho3d/logs",
    )
